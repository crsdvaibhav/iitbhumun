            ...
            <div className="w-full hidden flex-col bg-[#1A1E21] mt-[140px] text-white sm:flex">
                <div className="flex mt-[60px]">
                    <div className="ml-[70px] mr-[75.5px]">
                        <Image src="/images/footer-logo.svg" width={152} height={159.46} />
                    </div>
                        ...
                        <div className="flex flex-col">
                            ...
                            <div>
                                ...
                                <div className="mt-[20px] flex flex-col font-custom text-[20px] font-medium">
                                    <div>
                                        <a className="flex">
                                            <Image src="/images/location.svg" width={24} height={28.8}/>
                                            <p className="pl-[33px]">IIT (BHU), Varanasi, India.</p>
                                        </a>
                                    </div>
                                    <div className="mt-[23.7px]">
                                        <a className="flex">
                                            <Image src="/images/mail.svg" width={24} height={19.2}/>
                    ...
                    <div className="ml-[216px] mr-[196.42]">
                        ...
                        <div className="mt-[60px]">
                            ...
                            <div className="mt-[20px] flex">
                                <a className="mr-[29px]"><Image src="/images/ig.svg" width={24.08} height={24.08} /></a>
                                <a className="mx-[29px]"><Image src="/images/linkedin.svg" width={24} height={21}/></a>
                                <a className="mx-[29px]"><Image src="/images/twitter.svg" width={28} height={22}/></a>
                                <a className="ml-[29px]"><Image src="/images/medium.svg" width={38.5} height={22}/></a>
                            </div>
                        </div>
                    </div>
                </div>
