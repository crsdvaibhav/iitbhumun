...
export default function Main() {
    return (
        <div className="w-full pt-[3.125rem] bg-[#F5F5F5]">
            <p className="font-bold font-heading text-center text-[#1A1E21] text-xl sm:text-[2.5rem]">
                We will be back in
            </p>
            <CountdownElement />
            <div className="w-full mt-16 sm:mt-[8.75rem]">
                <p className="font-bold font-heading text-center text-[#1A1E21] text-xl sm:text-[2.5rem]">
                    Legacy
                </p>
                <div className="hidden sm:flex justify-center mt-[3.75rem]">
            ...
            <div className="mt-12 sm:mt-[8.75rem]">
                ...
                <div className="flex justify-center mt-8 sm:mt-[3.75rem] overflow-x-scroll">
