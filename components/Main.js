        ...
        <div className="w-full pt-[50px] bg-[#F5F5F5]">
            ...
            <div className="w-full mt-16 sm:mt-[140px]">
                ...
                <div className="flex justify-center mt-8 sm:mt-[60px]">
                    <div className="mr-2 sm:mx-[121px] flex flex-col items-center">
                        <Image src="/images/legacy-circles.svg" width={100} height={100} alt="legacy"/>
                        <span className="mt-[4px] text-xs sm:text-[20px] font-custom text-[#189BA5] sm:font-medium font-semibold">Delegates</span>
                    </div>
                    <div className="mx-2 sm:mx-[121px] flex flex-col items-center">
                        <Image src="/images/legacy-circles.svg" width={100} height={100} alt="legacy"/>
                        <span className="mt-[4px] text-xs sm:text-[20px] font-custom text-[#189BA5] sm:font-medium font-semibold">Countries</span>
                    </div>
                    <div className="ml-2 sm:mx-[121px] flex flex-col items-center">
                        <Image src="/images/legacy-circles.svg" width={100} height={100} alt="legacy"/>
                        <span className="mt-[4px] text-xs sm:text-[20px] font-custom text-[#189BA5] sm:font-medium font-semibold">Conferences</span>
                    </div>
            ...
            <div className="mt-12 sm:mt-[140px]">
                ...
                <div className="sm:hidden mt-4">
                    ...
                    <div className="flex px-8">
                        <div className="font-custom font-semibold text-[10px] text-[#189BA5] text-center">UNESCO (INCCU</div>
                        <div className="font-custom font-semibold text-[10px] text-[#189BA5] text-center ml-[22px]">UN information Centre <br/>for India and Bhutan</div>
                        <div className="font-custom font-semibold text-[10px] text-[#189BA5] text-center ml-[20px]">MUN Refugee <br/>Challenge</div>
                    </div>
                </div>
            </div>
            <div className="mt-12 sm:mt-[140px]">
